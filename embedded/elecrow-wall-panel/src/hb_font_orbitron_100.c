 ...
 * Size: 100 px
 * Bpp: 4
 * Opts: --size 100 --bpp 4 --format lvgl --font /tmp/homebrain-panel-assets/Orbitron.ttf --symbols 0123456789-.%° --no-compress --no-prefilter --force-fast-kern-format --lv-include lvgl.h --lv-font-name hb_font_orbitron_100 -o ~/HomeBrainv2/embedded/elecrow-wall-panel/src/hb_font_orbitron_100.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 27986, .adv_w = 702, .box_w = 35, .box_h = 33, .ofs_x = 4, .ofs_y = 40}
};
