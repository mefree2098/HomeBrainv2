...
const ROUTE_META: Record<string, { label: string; detail: string }> = {
  ...
  "/reachy-mini": { label: "Reachy Mini", detail: "Robot voice, sensing, and motion" },
  ...
  "/platform-services": { label: "Platform Services", detail: "Managed infrastructure and companion packages" },
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          >
            ...
            <div className="hidden h-11 min-w-0 flex-1 items-center overflow-hidden sm:flex">
              <p className="block max-w-full truncate text-sm font-semibold leading-none tracking-normal text-foreground/85">
                HomeBrain OS
              </p>
            </div>
          </button>
