...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "card-shell rounded-[calc(var(--radius)*1.15)] text-card-foreground transition-transform duration-300",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-[-0.03em] sm:text-xl",
      className
    )}
    {...props}
  />
