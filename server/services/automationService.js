  ...
  try {
    ...
    devices.forEach(device => {
      ...
      const deviceInfo = {
        ...
        harmonyEntityType: device?.properties?.harmonyEntityType || null,
        harmonyDeviceId: device?.properties?.harmonyDeviceId || null,
        harmonyDeviceLabel: device?.properties?.harmonyDeviceLabel || null,
