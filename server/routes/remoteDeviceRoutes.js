...
router.post('/:deviceId/tts', express.json({ limit: '8kb' }), remoteTtsRateLimit, async (req, res) => {
  const { deviceId } = req.params;
  ...
  try {
    ...
    console.error(`POST /api/remote-devices/${deviceId}/tts - Error:`, error.message);
